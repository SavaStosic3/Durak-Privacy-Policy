...
3. Tap **Delete account**, enter your password to confirm, then confirm the
   deletion.
...
- Your account and sign-in credentials (email and password), held by Firebase
  Authentication.
- Your public username and its reservation.
...
created — your username and its reservation, your online stats, and your friends,
friend requests, and blocked-users list. Two small things can remain:

- **Safety records.** If you or another player filed an abuse report, that report
  is kept for safety and moderation. Reports can reference the accounts involved,
  so a report may still contain your account identifier.
- **Blocks placed by others.** If another player blocked you, that block stays on
  *their* account. It is private to them and is never shown to anyone else.

We keep these only as long as needed to keep the service safe.

## Can't open the app?

If you cannot sign in or open the app, email **[email redacted]** from the
